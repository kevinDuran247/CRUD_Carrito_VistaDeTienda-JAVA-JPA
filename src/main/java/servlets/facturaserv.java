...
public class facturaserv extends HttpServlet {
    DetallepedidoJpaController factura = new DetallepedidoJpaController();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        int idcliente = Integer.parseInt(request.getParameter("idp"));
        List<Detallepedido> facturas = factura.findDetallePedidosByIdPedido(idcliente);
        request.setAttribute("factura", facturas);
        RequestDispatcher dispatcher = request.getRequestDispatcher("detalleFactura.jsp");
